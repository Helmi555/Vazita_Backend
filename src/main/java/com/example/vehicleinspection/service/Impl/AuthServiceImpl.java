...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserRepository userRepository, GroupRepository groupRepository, CentreCVTRepository centreCVTRepository, PasswordEncoder passwordEncoder, JwtUtils jwtUtils) {
